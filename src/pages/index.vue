...
<template>
    <div>
        ...
        <div
            class="flex h-full flex-col bg-primary-600/70 dark:bg-black shadow-2xl border-primary-700 hover:border-primary-950 dark:border-primary-900 hover:dark:border-primary-500 border">
